  ...
  render: function() {
    ...
    return (
      <div className="track">
        ...
        <button title="play" onClick={this.playTrack}><i className="fa fa-play-circle-o"></i></button>
        <button title="delete" onClick={this.deleteTrack}><i className="fa fa-trash-o"></i></button>
      </div>
    );
  }
});
